...
public class BTestUtils {
    ...
    public static void invoke(CompileResult compileResult, String functionName, BValue[] args, JMSConnectorFutureListener callback){
    ...
    public static void invoke(CompileResult compileResult, String functionName, BValue[] args, WorkerExecutionContext context, JMSConnectorFutureListener callback){
    ...
    public static BValue[] invoke(CompileResult compileResult, String functionName, BValue[] args, WorkerExecutionContext context){
        ProgramFile programFile = compileResult.getProgFile();
        PackageInfo packageInfo = programFile.getPackageInfo(programFile.getEntryPkgName());
        FunctionInfo callableUnitInfo = packageInfo.getFunctionInfo(functionName);
